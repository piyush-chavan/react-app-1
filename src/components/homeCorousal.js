...
function homeCorousal() {
    ...
    return (
        <>
            <div className="carousal-container" style={{maxWidth:'100%'}}>
                <div id="carouselExampleCaptions" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption back-blur d-md-block"> 
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption back-blur d-md-block">
                                ...
                                <p>
                                    This high-resolution image of the Hubble Ultra Deep Field includes galaxies of various ages, sizes, shapes, and colors.</p>
                            </div>
                        </div>
                    </div>
